...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_text_1 .v-container-padding-padding { padding: 10px 10px 20px !important; } #u_content_text_2 .v-container-padding-padding { padding: 20px 10px !important; } #u_content_text_4 .v-container-padding-padding { padding: 20px 10px 10px !important; } }
    </style>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="{{asset('assets/images/reset-password.png')}}" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 50%;max-width: 290px;" width="290"/>
...
<table id="u_content_text_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    ...
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;">{{$employee->email}}</p>
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;"><strong>New Password: </strong></p>
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;">{{$new_password}}</p>
  </div>
